...
var DayPicker = React.createClass({displayName: "DayPicker",
    ...
    render: function (){
        ...
        var previousMonthDays = daysArray.map(function(day){
            ...
            return React.createElement(Day, {date: thisDate, week: 1, changeDate: this.selectDay, key: thisDate})
        }.bind(this));
        ...
        var actualMonthDays = daysArray.map(function(day) {
            ...
            return React.createElement(Day, {selected: selected, date: thisDate, week: weekNumber, changeDate: this.selectDay, key: thisDate})
        }.bind(this));
        ...
        var nextMonthDays = daysArray.map(function(day){
            ...
            return React.createElement(Day, {date: thisDate, week: weekNumber, changeDate: this.selectDay, key: thisDate})
        }.bind(this));
